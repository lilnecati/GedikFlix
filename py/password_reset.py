...
# Logging ayarları
logging.basicConfig(filename='password_reset_error.log', level=logging.DEBUG)
...
class PasswordReset:
    def __init__(self):
        ...
        self.smtp_port = 587
        self.sender_email = "snakecollections4@gmail.com" 
        self.sender_password = "epza hubt quuq lxao" 
        
    def send_reset_email(self, to_email, username):
        ...
        try:
            ...
            <body style="margin: 0; padding: 0; font-family: Arial, sans-serif;">
                ...
                <div style="background: linear-gradient(45deg, #901a58, #c7267e); padding: 40px 20px; text-align: center;">
                    <h2 style="color: #fff; margin-bottom: 20px; font-size: 32px;">ŞİFRE SIFIRLAMA</h2>
                ...
                <div style="padding: 40px 20px; text-align: center;">
                    <div style="display: inline-block; background-color: #f8f9fa; border: 2px dashed #901a58; padding: 20px 40px; border-radius: 10px;">
                        <h2 style="color: #901a58; letter-spacing: 8px; margin: 0; font-size: 36px;">{reset_code}</h2>
                    ...
                    <div style="margin-top: 40px; display: flex; justify-content: center; gap: 20px;">
                        <div style="background-color: #f8f9fa; padding: 20px; border-radius: 10px; text-align: center; width: 200px;">
                            ...
                            <h3 style="color: #333; margin: 10px 0;">Güvenli Erişim</h3>
                            <p style="color: #666; font-size: 14px;">Hesabınızı güvenle koruyun</p>
                        </div>
                        
                        <div style="background-color: #f8f9fa; padding: 20px; border-radius: 10px; text-align: center; width: 200px;">
                            <div style="font-size: 32px;">🔑</div>
                            <h3 style="color: #333; margin: 10px 0;">Kolay Şifre Sıfırlama</h3>
                            <p style="color: #666; font-size: 14px;">Hızlı ve güvenli</p>
                        </div>
                        
                        <div style="background-color: #f8f9fa; padding: 20px; border-radius: 10px; text-align: center; width: 200px;">
                            <div style="font-size: 32px;">📱</div>
                            <h3 style="color: #333; margin: 10px 0;">Her Cihazdan Erişim</h3>
                            <p style="color: #666; font-size: 14px;">Tüm cihazlarınızdan izleyin</p>
                        </div>
                    </div>
                </div>
                ...
                <div style="background-color: #fff8f6; border-left: 4px solid #901a58; padding: 15px; margin: 25px auto; max-width: 500px;">
                    ...
                    <p style="color: #666; margin: 0; font-size: 14px;">
                        Bu şifre sıfırlama isteğini siz göndermediyseniz, lütfen dikkate almayın ve 
                        hesabınızın güvenliğini sağlamak için şifrenizi değiştirin.
                    </p>
                </div>
            ...
            msg['Subject'] = "GedikFlix - Şifre Sıfırlama Kodunuz"
            ...
            return {'success': True, 'code': reset_code}
...
if __name__ == "__main__":
    try:
        ...
        reset = PasswordReset()
        result = reset.send_reset_email(email, username)
